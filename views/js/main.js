...
var selectRandomMeat = function() { var randomMeat = pizzaIngredients.meats[Math.floor((Math.random() * pizzaIngredients.meats.length))];
  return randomMeat;
};
...
var resizePizzas = function(size) {
  window.performance.mark("mark_start_resize");    function changeSliderLabel(size) {  switch(size) {
      case "1":
  ...
  function determineDx (elem, size) {var oldWidth = elem.offsetWidth;var windowWidth = document.querySelector("#randomPizzas").offsetWidth;var oldSize = oldWidth / windowWidth;
